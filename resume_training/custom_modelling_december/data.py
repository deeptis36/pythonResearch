...
skill_array = [
   "testng",
    ...
    "Java", "JavaScript", "TypeScript", "Python", "PHP", "Ruby", "C#",  "C++", "Swift", "Kotlin", "Go", "Rust", "R", "Scala",
...
roles_array = [
    "IT Manager","IT Lead","IT Director",
    "Senior Network Security Engineer (Contractor for Comtec)",
    "Network Security Engineer",
    "Adjunct Instructor","instructor","Sr. Software Engineer",
    "Sr. TIBCO Application Developer /Administrator","Sr. TIBCO Application Developer",
    "TIBCO Developer","tibco administrator/developer","TIBCO Lead Developer",
    "Senior IT Infrastructure Engineer","project manager/senior network engineer",
    "ML Engineer/ MLOps Engineer","Adjunct Instructor",
    "senior developer","Software Engineer Consultant","Software Engineer Intern",
    ...
    "maintenance lead","Sr Mulesoft Developer/Feature Lead",
    "Sr MuleSoft Lead Developer","Sr. MuleSoft Lead Developer",
    "Salesforce QA Tester","Quality Assurance",
    ...
    "ERP Implementation Specialist | Team Leader | Developer/Analyst","Senior Network Administrator / Engineer"
]
...
company_names = [
    "Infotech, India"," Sidhi Infotech, India",
    "Health partners Bloomington MN","Honeywell, Morristown, NJ","Abilo IT Solutions, India	",
    "Stoller USA, Houston, Texas",
    "ITCubed, Houston, Texas",
    "WCJC, Richmond, Texas",
    "Siri software solutions",
    "GATX, Chicago, IL",
    "Cognizant, Atlanta, GA",
    "WCJC, Richmond","EnerMech, Houston, Texas",
    "Amazon","Azure Computers",
    "Google",
    "Microsoft",
    "IBM",
    "Apple",
    ...
    "hp",
    "IBM",
    "opentext","Ard Corp","Boston University",
]
