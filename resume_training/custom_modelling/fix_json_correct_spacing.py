...
def get_words(text,entities):
    ...
    for entity in entities:
        ...
        with open("temp-output.txt", "a") as f:
         f.write(f"{start} | {end} | {label} | {substring}\n")
...
input_file = 'json/train_data.json'  # Replace with your input file path
output_file = 'json/train_data_spacting_fix.json'  # Replace with your output file path
